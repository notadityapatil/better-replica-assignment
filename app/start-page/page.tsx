...
export default function StartPage() {
    ...
    useEffect(() => {
        ...
        const handleScroll = () => {
          if (!navbar || !footer) return; // Check if navbar and footer exist
      
          const footerTop = footer.getBoundingClientRect().top;
          const navbarHeight = navbar.offsetHeight;
      
          // If the footer is within the viewport and near the navbar, switch position
  ...
  return (
    <div className="w-screen">
      <div id="navbar" className="sticky top-0 z-10 w-full bg-white">
        ...
        {/* Line container */}
        <div className="relative w-full px-8 flex items-center">
          {/* Line */}
          <div className="h-1 w-full bg-gray-300 rounded-full"></div>

          {/* Circle in center */}
          <div className="absolute left-1/2 transform -translate-x-1/2 w-10 h-10 bg-gray-300 rounded-full">
            <Image
      ...
      <div className="h-[120vh] bg-white text-black">
        ...
        <div className="flex flex-col items-center justify-center gap-5 mt-6">
          <div className="flex flex-row items-center justify-start px-7 p-4 h-12 border border-gray-400 w-1/2  rounded-lg hover:border-[#017848] hover:border-2 transition-all duration-100 hover:text-[#017848]">
            ...
            <div className="ml-5">
              <h1 className="text-md">Buying a Home</h1>
            </div>
          </div>
          ...
          <div className="flex flex-row items-center justify-start px-7 p-4 h-12 border border-gray-400 w-1/2  rounded-lg hover:border-[#017848] hover:border-2 transition-all duration-100 hover:text-[#017848]">
            ...
            <div className="ml-5">
              <h1 className="text-md">Refinance my mortgage</h1>
            </div>
          </div>
          ...
          <div className="flex flex-row items-center justify-start px-7 p-4 h-12 border border-gray-400 w-1/2  rounded-lg hover:border-[#017848] hover:border-2 transition-all duration-100 hover:text-[#017848]">
            ...
            <div className="ml-5">
              <h1 className="text-md">Get cash from my home</h1>
            </div>
          </div>
        </div>

        <div className="w-full flex justify-center flex-row p-10">
          <div className="w-1/2 justify-between flex flex-row">
              ...
              <div className="flex flex-row gap-2 items-center">
                <div>
                  <svg
                    ...
                    xmlns="http://www.w3.org/2000/svg"
                  >
                    <title id="percentage-outlined-icon">
                      Percentage Outlined
                    </title>
                    <path
                      clipRule="evenodd"
